...
// Tests unsigned integer for 32 bit integers
// Should be valid
#[condition(pre="(x: u32 <= 10u32) && (x: u32 >= 0u32)", post="return: u32 < 6u32")]
...
// Tests unsigned integer for 32 bit integers
// Should be valid
#[condition(pre="(x: u32 > 0u32) && (x: u32 < 10u32)", post="return: u32 > -10u32")]
...
// Tests unsigned integer for 32 bit integers
// Should be valid
#[condition(pre="(x: u32 == 0u32)", post="return: u32 == 10u32")]
