...
use expression::{Expression, UnaryOperator, UnaryExpressionData, BinaryOperator, BinaryExpressionData, VariableMappingData, substitute_variable_with_expression, determine_evaluation_type};
...
fn determine_evaluation_type_comparison_unary(){
	let u: Expression = Expression::VariableMapping( VariableMappingData{name: "x".to_string(), var_type:"bool".to_string()});
...
fn determine_evaluation_type_comparison_binary(){
	let left_side: Expression = Expression::VariableMapping( VariableMappingData{name:"x".to_string(), var_type: "i32".to_string()});
	let right_side: Expression = Expression::VariableMapping( VariableMappingData{name:"y".to_string(), var_type: "i32".to_string()});
